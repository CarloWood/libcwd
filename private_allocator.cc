...
#if CWDEBUG_MAGIC
static size_t const _malloc_overhead_c = sizeof(prezone) + sizeof(size_t) - 1 + sizeof(postzone) + CW_MALLOC_OVERHEAD;
#else
static size_t const _malloc_overhead_c = CW_MALLOC_OVERHEAD;
#endif
