...
#define PRAGMA_DIAGNOSTIC_PUSH_IGNORE_class_memaccess \
  _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wclass-memaccess\"")
#else
#define PRAGMA_DIAGNOSTIC_PUSH_IGNORE_class_memaccess _Pragma("GCC diagnostic push")
#endif
...
#else
#define PRAGMA_DIAGNOSTIC_PUSH_IGNORE_stringop_overflow _Pragma("GCC diagnostic push")
#endif
...
#define PRAGMA_DIAGNOSTIC_PUSH_IGNORE_mismatched_new_delete \
  _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wmismatched-new-delete\"")
