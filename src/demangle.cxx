// SPDX-FileCopyrightText: 2001-2004, 2006-2007, 2018-2020, 2026 Carlo Wood
...
void print_IEEE_fp(char* buf, unsigned long* words, int nbits_exponent, int nbits_fraction, int precision)
{
  ...
  unsigned long mask_last_elem = ~((1UL << (nelem_fraction * 32 - nbits_fraction - nbits_exponent - 1)) - 1);
...
bool implementation_details::decode_real(char* output, unsigned long* input, size_t size_of_real) const
{
