...
@brief The default LIBCWD_DEBUG_CHANNELS namespace.

This macro should contain the namespace where your application defines the <span class="tt">@link preparation dc@endlink</span> namespace;
If you want to define additional %debug %channels, next to the ones already @link libcwd::channels::dc provided @endlink
by libcwd, then the macro LIBCWD_DEBUG_CHANNELS must be defined in the custom @link preparation debug.h @endlink
