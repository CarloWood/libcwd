...
int main()
{
  ...
  char const* expected[] = {
    ...
    "libcwd::cwprint_using_tct<libcw::_private_::GlobalObject> libcwd::cwprint_using<libcw::_private_::GlobalObject>(libcw::_private_::GlobalObject const&, void (libcw::_private_::GlobalObject::*)(std::ostream&) const)",
