...
WARNING :     (Object file (/usr/lib/debug)*/lib/libc-2.[.0-9]*.so does not have debug info.*|Cannot find symbol _end in file \./module\.so)
...
BFD     :     address 0x[0-9a-f]* corresponds to module\.cc:25
MALLOC  : <continued> 0x[0-9a-f]* \[module\.cc:25\]
...
MALLOC  : free\(0x[0-9a-f]*\) *module\.cc:25 *void\*; \(sz = 310\)  Allocated inside global_test_symbol 
MALLOC  : free\(0x[0-9a-f]*\) *module\.cc:14 *void\*; \(sz = 300\)  Allocated inside static_test_symbol 
// input lines 2
