...
BFD     : address 0x[0-9a-f]+ corresponds to bfd\.cc:116
NOTICE  : called from bfd\.cc:116
BFD     : address 0x[0-9a-f]+ corresponds to bfd\.cc:142
NOTICE  : called from bfd\.cc:142
// input lines 3
