...
MALLOC  : malloc\(1111\) = 0x[0-9a-f]* \[tst_leak_shared:main\]
MALLOC  : malloc\(2222\) = 0x[0-9a-f]* \[tst_leak_shared:main\]
MALLOC  : malloc\(3333\) = 0x[0-9a-f]* \[tst_leak_shared:main\]
MALLOC  : malloc\(4444\) = 0x[0-9a-f]* \[tst_leak_shared:main\]
MALLOC  : operator new \(size = 8\) = 0x[0-9a-f]* \[tst_leak_shared:main\]
MALLOC  : New libcwd::marker_ct at 0x[0-9a-f]*
MALLOC  : operator new \(size = 16\) = 0x[0-9a-f]* \[tst_leak_shared:main\]
MALLOC  : operator new \(size = 8\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN11test_objectC1Ev\]
MALLOC  : malloc\(1212\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN2AAC1Ev\]
MALLOC  : malloc\(7334\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN2AAC1Ev\]
MALLOC  : malloc\(12345\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN11test_objectC1Ev\]
MALLOC  : malloc\(111\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN11test_objectC1Ev\]
MALLOC  : operator new \(size = 8\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN11test_objectC1Ev\]
MALLOC  : malloc\(1212\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN2AAC1Ev\]
MALLOC  : malloc\(7334\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN2AAC1Ev\]
MALLOC  : malloc\(5555\) = 0x[0-9a-f]* \[tst_leak_shared:main\]
MALLOC  : operator new \(size = 8\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN11test_objectC1Ev\]
MALLOC  : malloc\(1212\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN2AAC1Ev\]
MALLOC  : malloc\(7334\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN2AAC1Ev\]
MALLOC  : malloc\(12345\) = 0x[0-9a-f]* \[tst_leak_shared:_ZN11test_objectC1Ev\]
