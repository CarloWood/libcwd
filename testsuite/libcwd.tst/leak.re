...
MALLOC  : malloc\(1212\) = 0x[0-9a-f]*
MALLOC  : malloc\(7334\) = 0x[0-9a-f]*
MALLOC  : Allocated memory: 75813 bytes in 23 blocks:
\(MARKER\)  0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker
...
MALLOC  : Allocated memory: 35117 bytes in 9 blocks:
\(MARKER\)  0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
...
MALLOC  : Removing libcw::debug::marker_ct at 0x[0-9a-f]* \(test marker\)
  ...
  \* malloc    0x[0-9a-f]*              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak
  \* malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak 
MALLOC  : Allocated memory: 35006 bytes in 8 blocks:
\(deleted\) 0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
...
MALLOC  : Allocated memory: 27672 bytes in 7 blocks:
\(deleted\) 0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
...
malloc    0x[0-9a-f]*              leak\.cc:94   void\*; \(sz = 2222\)  ptr2
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA 
MALLOC  : Allocated memory: 20338 bytes in 6 blocks:
\(deleted\) 0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
...
malloc    0x[0-9a-f]*              leak\.cc:94   void\*; \(sz = 2222\)  ptr2
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA 
MALLOC  : Allocated memory: 13004 bytes in 5 blocks:
\(deleted\) 0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak
malloc    0x[0-9a-f]*              leak\.cc:99   void\*; \(sz = 3333\)  ptr3
malloc    0x[0-9a-f]*              leak\.cc:94   void\*; \(sz = 2222\)  ptr2
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:57   void\*; \(sz = 111\)  test_object::leak 
MALLOC  : Allocated memory: 12893 bytes in 4 blocks:
\(deleted\) 0x[0-9a-f]*              leak\.cc:113  <marker>; \(sz = 4\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:36   void\*; \(sz = 7334\)  AA::leakAA
malloc    0x[0-9a-f]*              leak\.cc:99   void\*; \(sz = 3333\)  ptr3
malloc    0x[0-9a-f]*              leak\.cc:94   void\*; \(sz = 2222\)  ptr2
