...
\(MARKER\)  0x[0-9a-f]*              leak\.cc:95   <marker>; \(sz = 1\)  test marker
    ...
    malloc    0x[0-9a-f]*              leak\.cc:104  void\*; \(sz = 5555\)  ptr5
    malloc    0x[0-9a-f]*              leak\.cc:33   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:31   void\*; \(sz = 1212\)  AA::ptr
              0x[0-9a-f]*              leak\.cc:54   AA; \(sz = 8\)  test_object::b
    malloc    0x[0-9a-f]*              leak\.cc:52   void\*; \(sz = 111\)  test_object::leak
    ...
    malloc    0x[0-9a-f]*              leak\.cc:31   void\*; \(sz = 1212\)  AA::ptr
              0x[0-9a-f]*              leak\.cc:48   AA; \(sz = 8\)  test_object::a
              0x[0-9a-f]*              leak\.cc:97   test_object; \(sz = 16\) 
malloc    0x[0-9a-f]*              leak\.cc:89   void\*; \(sz = 4444\)  ptr4
malloc    0x[0-9a-f]*              leak\.cc:86   void\*; \(sz = 3333\)  ptr3
malloc    0x[0-9a-f]*              leak\.cc:83   void\*; \(sz = 2222\)  ptr2
malloc    0x[0-9a-f]*              leak\.cc:80   void\*; \(sz = 1111\)  ptr1
...
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:80   void\*; \(sz = 1111\)  ptr1 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:89   void\*; \(sz = 4444\)  ptr4 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:31   void\*; \(sz = 1212\)  AA::ptr 
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:54   AA; \(sz = 8\)  test_object::b 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:50   void\*; \(sz = 12345\)  test_object::ptr 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:31   void\*; \(sz = 1212\)  AA::ptr 
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:48   AA; \(sz = 8\)  test_object::a 
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:97   test_object; \(sz = 16\)  
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:104  void\*; \(sz = 5555\)  ptr5 
...
MALLOC  : Removing debugmalloc_marker_ct at 0x[0-9a-f]* \(test marker\)
  ...
  \* malloc    0x[0-9a-f]*              leak\.cc:52   void\*; \(sz = 111\)  test_object::leak
  \* malloc    0x[0-9a-f]*              leak\.cc:33   void\*; \(sz = 7334\)  AA::leakAA
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:95   <marker>; \(sz = 1\)  test marker 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:52   void\*; \(sz = 111\)  test_object::leak 
MALLOC  : Allocated memory: 35003 bytes in 8 blocks\.
\(deleted\) 0x[0-9a-f]*              leak\.cc:95   <marker>; \(sz = 1\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:33   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:52   void\*; \(sz = 111\)  test_object::leak
    malloc    0x[0-9a-f]*              leak\.cc:33   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:33   void\*; \(sz = 7334\)  AA::leakAA
...
malloc    0x[0-9a-f]*              leak\.cc:86   void\*; \(sz = 3333\)  ptr3
malloc    0x[0-9a-f]*              leak\.cc:83   void\*; \(sz = 2222\)  ptr2
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:83   void\*; \(sz = 2222\)  ptr2 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:86   void\*; \(sz = 3333\)  ptr3 
