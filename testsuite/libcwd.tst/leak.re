...
\(MARKER\)  0x[0-9a-f]*              leak\.cc:96   <marker>; \(sz = 1\)  test marker
    ...
    malloc    0x[0-9a-f]*              leak\.cc:105  void\*; \(sz = 5555\)  ptr5
    malloc    0x[0-9a-f]*              leak\.cc:34   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:32   void\*; \(sz = 1212\)  AA::ptr
              0x[0-9a-f]*              leak\.cc:55   AA; \(sz = 8\)  test_object::b
    malloc    0x[0-9a-f]*              leak\.cc:53   void\*; \(sz = 111\)  test_object::leak
    ...
    malloc    0x[0-9a-f]*              leak\.cc:32   void\*; \(sz = 1212\)  AA::ptr
              0x[0-9a-f]*              leak\.cc:49   AA; \(sz = 8\)  test_object::a
              0x[0-9a-f]*              leak\.cc:98   test_object; \(sz = 16\) 
malloc    0x[0-9a-f]*              leak\.cc:90   void\*; \(sz = 4444\)  ptr4
malloc    0x[0-9a-f]*              leak\.cc:87   void\*; \(sz = 3333\)  ptr3
malloc    0x[0-9a-f]*              leak\.cc:84   void\*; \(sz = 2222\)  ptr2
malloc    0x[0-9a-f]*              leak\.cc:81   void\*; \(sz = 1111\)  ptr1
...
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:81   void\*; \(sz = 1111\)  ptr1 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:90   void\*; \(sz = 4444\)  ptr4 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:32   void\*; \(sz = 1212\)  AA::ptr 
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:55   AA; \(sz = 8\)  test_object::b 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:51   void\*; \(sz = 12345\)  test_object::ptr 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:32   void\*; \(sz = 1212\)  AA::ptr 
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:49   AA; \(sz = 8\)  test_object::a 
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:98   test_object; \(sz = 16\)  
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:105  void\*; \(sz = 5555\)  ptr5 
...
MALLOC  : Removing libcw::debug::marker_ct at 0x[0-9a-f]* \(test marker\)
  ...
  \* malloc    0x[0-9a-f]*              leak\.cc:53   void\*; \(sz = 111\)  test_object::leak
  \* malloc    0x[0-9a-f]*              leak\.cc:34   void\*; \(sz = 7334\)  AA::leakAA
MALLOC  : delete 0x[0-9a-f]*              leak\.cc:96   <marker>; \(sz = 1\)  test marker 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:53   void\*; \(sz = 111\)  test_object::leak 
MALLOC  : Allocated memory: 35003 bytes in 8 blocks\.
\(deleted\) 0x[0-9a-f]*              leak\.cc:96   <marker>; \(sz = 1\)  test marker
    malloc    0x[0-9a-f]*              leak\.cc:34   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:53   void\*; \(sz = 111\)  test_object::leak
    malloc    0x[0-9a-f]*              leak\.cc:34   void\*; \(sz = 7334\)  AA::leakAA
    malloc    0x[0-9a-f]*              leak\.cc:34   void\*; \(sz = 7334\)  AA::leakAA
...
malloc    0x[0-9a-f]*              leak\.cc:87   void\*; \(sz = 3333\)  ptr3
malloc    0x[0-9a-f]*              leak\.cc:84   void\*; \(sz = 2222\)  ptr2
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:84   void\*; \(sz = 2222\)  ptr2 
MALLOC  : free\(0x[0-9a-f]*\)              leak\.cc:87   void\*; \(sz = 3333\)  ptr3 
