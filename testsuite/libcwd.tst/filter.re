...
MALLOC  : operator new \(size = 8\) = 0x[a-f0-9]* \[filter\.cc:191\]
...
MALLOC  : delete 0x[a-f0-9]*            filter\.cc:191  <marker>; \(sz = 8\)  marker1 
MALLOC  : Allocated memory: [0-9]* bytes in [0-9]* blocks\.
\(deleted\) 0x[a-f0-9]* main           filter\.cc:191  <marker>; \(sz = 8\)  marker1
...
[0-9:.]* \(deleted\) 0x[a-f0-9]* tst_filter_(static|shared):           filter\.cc:191  <marker>; \(sz = 8\)  marker1
