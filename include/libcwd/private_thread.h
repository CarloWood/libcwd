...
// iterators while tracking thread lifetime for fatal debug-output paths.
//
class thread_ct
{
 public:
...
// thread object in its final list location. mark_thread_terminated serializes lifetime updates with insertions
// and future list traversals.
struct ThreadList
{
  class impl_ct;
