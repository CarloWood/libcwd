...
template<class TYPE>
  ...
  {
    typedef ::libcw::omanip_id_tct<typename TYPE::omanip_data_ct> omanip_id_ct;
...
template<class TYPE>
  ...
  {
    typedef ::libcw::imanip_id_tct<typename TYPE::imanip_data_ct> imanip_id_ct;
...
#define __DEFINE_OMANIP1_OPERATOR(TYPE, TP1) \
  friend inline ostream& operator<<(ostream& os, ::libcw::manip1_tct<void (omanip_data_ct::*)(TP1), TP1> const& m) \
...
#define __DEFINE_IMANIP1_OPERATOR(TYPE, TP1) \
  friend inline istream& operator>>(istream& is, ::libcw::manip1_tct<void (libcw::imanip_data_ct::*)(TP1), TP1> const& m) \
      { (::libcw::get_imanip_data<TYPE>(is).*m.func)(m.param1); return is; }

#define __DEFINE_IMANIP1_FUNCTION(function, TP1) \
  static inline ::libcw::manip1_tct<void (::libcw::imanip_data_ct::*)(TP1), TP1> function(TP1 p1) \
      { return ::libcw::manip1_tct<void (::libcw::imanip_data_ct::*)(TP1), TP1>(&::libcw::imanip_data_ct::function, p1); }
...
#define __DEFINE_OMANIP2_OPERATOR(TYPE, TP1, TP2) \
  friend inline ostream& operator<<(ostream& os, ::libcw::manip2_tct<void (omanip_data_ct::*)(TP1, TP2), TP1, TP2> const& m) \
...
#define __DEFINE_IMANIP2_OPERATOR(TYPE, TP1, TP2) \
  friend inline istream& operator>>(istream& is, ::libcw::manip2_tct<void (imanip_data_ct::*)(TP1, TP2), TP1, TP2> const& m) \
