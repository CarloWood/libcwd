...
#define MyOwnDout(cntrl, ...) LibcwDout(libcwd::channels, my_own_do, cntrl, __VA_ARGS__)
#define ExampleDout(cntrl, ...) LibcwDout(libcwd::channels, example::my_own_do, cntrl, __VA_ARGS__)
